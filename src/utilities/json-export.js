...
function importDatabase(docID, sheetName) {
  ...
  var json = makeJSON_(rowsData, getExportOptions());
  //Logger.log(json)
  return json;
}
...
function displayText_(text) {
  ...
  SpreadsheetApp.getUi()
      .showModalDialog(output, 'Tabla en formato JSON');
}
...
function getRowsData_(sheet, options) {
  ...
  var dataRange = sheet.getRange(1+1, 1, sheet.getMaxRows(), sheet.getMaxColumns());
